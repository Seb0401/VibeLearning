...
const IcoTimer    = () => <Svg><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/><line x1="12" y1="2" x2="12" y2="4"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/></Svg>;
...
export default function Sidebar({ userName }) {
  ...
  const S = {
    ...
    logoArea:  { display: "flex", alignItems: "center", gap: 10, padding: "24px 20px 20px" },
    logoIcon:  { width: 32, height: 32, borderRadius: 9, background: "linear-gradient(135deg, #7C6CF8 0%, #A78BFA 100%)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, boxShadow: "0 4px 12px rgba(124,108,248,0.3)" },
    logoText:  { fontWeight: 700, fontSize: 15, color: "var(--text)", letterSpacing: "-0.01em" },
    navSection:{ padding: "4px 12px", display: "flex", flexDirection: "column", gap: 2 },
    navLabel:  { fontSize: 10, fontWeight: 600, color: "var(--text-3)", letterSpacing: "0.08em", textTransform: "uppercase", padding: "8px 8px 4px" },
    divider:   { height: 1, background: "var(--border)", margin: "8px 20px" },
    footer:    { padding: "12px" },
    userRow:   { display: "flex", alignItems: "center", gap: 10, padding: "10px 8px", borderRadius: 10, cursor: "pointer", transition: "background 150ms ease" },
    avatar:    { width: 34, height: 34, borderRadius: "50%", background: "linear-gradient(135deg, var(--accent), #A78BFA)", display: "flex", alignItems: "center", justifyContent: "center", color: "white", fontWeight: 700, fontSize: 14, flexShrink: 0 },
  };
  ...
  return (
    <aside style={S.root}>
      ...
      <div>
        <div style={S.divider} />
        <div style={S.footer}>
          <div className="nav-item" style={{ display: "flex", alignItems: "center", gap: 10, padding: "9px 10px", borderRadius: 10, color: "var(--text-2)", fontSize: 14, cursor: "pointer", marginBottom: 4 }}>
            <IcoSettings />
            Ajustes
          </div>
          <div style={S.divider} />
          <div className="nav-item" style={S.userRow} onClick={handleSignOut} title="Cerrar sesión">
